...
# is it directory or not and delete only empty files
...
def DirectoryWatcher(DirectoryName = "Marvellous"):
    ...
    fobj.write("\n"*5)
    fobj.write(f"Total Number of files scanned : {TotalCount}\n")
    fobj.write(f"Total Number of empty files : {EmptyCount}\n")
    fobj.write("\n"*5)
